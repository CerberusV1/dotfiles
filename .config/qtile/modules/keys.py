...
keys = [
    ...
    #    Key(["control"], "2", lazy.group['scratchpad'].dropdown_toggle('discord'), desc="xPipe"),
    #    Key(["control"], "3", lazy.group['scratchpad'].dropdown_toggle('files'), desc="PopUp Filemanager"),
    Key(
        ["control"],
        "2",
